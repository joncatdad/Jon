...
public class Constants {
    ...
    public static final int[] KEYS = {
        ...
        KeyEvent.VK_ENTER, KeyEvent.VK_Z, KeyEvent.VK_X, KeyEvent.VK_C,
        KeyEvent.VK_V, KeyEvent.VK_B, KeyEvent.VK_N, KeyEvent.VK_M,
        KeyEvent.VK_BACK_SPACE, KeyEvent.VK_R};
    public static final int[][] KEYPLACEMENT = {
        {125, 234}, {174, 234}, {223, 234}, {272, 234}, {321, 234},
        {370, 234}, {419, 234}, {468, 234}, {517, 234}, {566, 234},
        {149, 168}, {198, 168}, {247, 168}, {296, 168}, {345, 168},
        {394, 168}, {443, 168}, {492, 168}, {541, 168},
        {139, 102}, {198, 102}, {247, 102}, {296, 102}, {345, 102},
        {394, 102}, {443, 102}, {492, 102}, {551, 102},
        {345, 36}}; // RESET key placement
    // Color constants can be added here as needed
}
