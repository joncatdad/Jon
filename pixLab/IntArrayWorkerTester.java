public class IntArrayWorkerTester{
	...
	public static void testReverseRows() {
	    ...
	    worker.print();  // Print before reversing
	    worker.reverseRows();  // Call the method to reverse the rows
	    System.out.println("Array after reverseRows:");
	    worker.print();  // Print after reversing
	}
	public static void main(String[] args) {
	    ...
	    testGetLargest();
	    testGetColTotal();
	    testReverseRows(); // Add this line to call the reverseRows test
	}
}
